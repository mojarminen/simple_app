...
if __name__ == '__main__':
    ...
    get_estimations('Crystal Palace', 'Chelsea', games)
    get_estimations('Middlesbrough', 'Swansea', games)
    get_estimations('Stoke City', 'Leicester', games)
    get_estimations('Sunderland', 'Watford', games)
    get_estimations('West Ham', 'Hull City', games)
    get_estimations('West Brom', 'Manchester United', games)
    get_estimations('Bournemouth', 'Southampton', games)
    get_estimations('Manchester City', 'Arsenal', games)
    get_estimations('Tottenham', 'Burnley', games)
    get_estimations('Everton', 'Liverpool', games)
