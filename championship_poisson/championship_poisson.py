...
if __name__ == '__main__':
    ...
    get_estimations('Norwich', 'Huddersfield', games)
    get_estimations('Blackburn', 'Reading', games)
    get_estimations('Bristol City', 'Preston', games)
    get_estimations('Burton', 'Newcastle Utd', games)
    get_estimations('Cardiff', 'Barnsley', games)
    get_estimations('Fulham', 'Derby', games)
    get_estimations('Leeds', 'Brentford', games)
    get_estimations('Nottingham', 'Wolves', games)
    get_estimations('Sheffield Wed', 'Rotherham', games)
    get_estimations('Wigan', 'Ipswich', games)
    get_estimations('Birmingham', 'Brighton', games)
    get_estimations('QPR', 'Aston Villa', games)
