...
DATAFILES = [
        'bundesliga_2016-2017.csv',
    ]

TEAMS = {
    '1. FC Koln': '1. FC Koln',
    '1. FSV Mainz 05': '1. FSV Mainz 05',
    'B. Monchengladbach': 'B. Monchengladbach',
...
if __name__ == '__main__':
    ...
    get_estimations('Dortmund', 'FC Augsburg', games)
    get_estimations('B. Monchengladbach', 'Wolfsburg', games)
    get_estimations('Hamburger SV', 'Schalke', games)
    get_estimations('Eintracht Frankfurt', '1. FSV Mainz 05', games)
