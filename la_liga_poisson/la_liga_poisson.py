...
if __name__ == '__main__':
    ...
    get_estimations('Alaves', 'Betis', games)
    get_estimations('Gijon', 'Villarreal', games)
    get_estimations('Atl. Madrid', 'Las Palmas', games)
    get_estimations('Granada CF', 'Real Sociedad', games)
    get_estimations('Sevilla', 'Malaga', games)
    get_estimations('Leganes', 'Eibar', games)
    get_estimations('Dep. La Coruna', 'Osasuna', games)
    get_estimations('Barcelona', 'Espanyol', games)
    get_estimations('Ath Bilbao', 'Celta Vigo', games)
